...
public class Admin extends Karyawan{
    ...
    public Admin(){ //constructor sekaligus untuk menginput data karyawan agar bisa dimasukkan ke dalam array di class Main
        ...
        System.out.println("========================================");
        if (getJabatan().equalsIgnoreCase("groomer") || getJabatan().equalsIgnoreCase("dokter hewan") || getJabatan().equalsIgnoreCase("admin")){

        }else {
            System.out.println("Maaf, Jabatan yang Anda Masukkan Tidak Ada.");
        }
    }
}